...
# cv2.imshow("contours", imageContours)
    cv2.imwrite('8 - imageContours.png', imageContours)
...
# cv2.imshow("contoursPossibleChars", imageContours)
    cv2.imwrite('9 - contoursPossibleChars.png', imageContours)
...
# cv2.imshow("finalContours", imageContours)
    cv2.imwrite('10 - finalContours.png', imageContours)
    ...
    for listOfMatchingChars in listOfListsOfMatchingChars:
        ...
        for i in range(0, len(plates_list)):
            ...
            xy_list.append(list(p2fRectPoints[0]))
            xy_list.append(list(p2fRectPoints[1]))
            xy_list.append(list(p2fRectPoints[2]))
